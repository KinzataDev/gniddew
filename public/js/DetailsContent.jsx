        ...
        return (
            <div className="buffer">
                ...
                <div className="row">
                    <div className="col-xs-5 detail-content expand-small">
                        <h2>Parking</h2>
                        <p>There are two parking structures located near Cuvee: 212 N. Milwaukee St and 225 E. Chicago
                            St. The cost to park is approximately $10.00.</p>
                        <p>
                            The <b><a href="http://www.historicthirdward.org/events/thirdwardartfestival.php">3rd Ward
                            Art Festival</a></b> will be happening <b>during</b> our wedding and
                            will take place on the street in front of Cuvee. Street parking will be limited so please
                            give yourself
                            enough time to find parking if you will not be using the structure. The festival is free -
                            feel welcome to arrive early and browse the artwork!
                        </p>

...
var AccommodationsContent = window.__Wedding__.AccomodationsContent;
    ...
    render: function () {
        ...
        return (
            <Tabs defaultActionKey={1} id="Main Tab">
                ...
                <Tab eventKey={4} title="ACCOMMODATIONS"><AccommodationsContent /></Tab>
                <Tab eventKey={5} title="REGISTRY"><RegistriesContent /></Tab>
